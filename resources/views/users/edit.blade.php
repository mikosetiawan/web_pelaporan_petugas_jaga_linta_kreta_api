        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Password (Biarkan kosong jika tidak ingin mengubah)</label>
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required
                            ...
                            <option value="korlap" {{ $user->role == 'korlap' ? 'selected' : '' }}>Korlap</option>
